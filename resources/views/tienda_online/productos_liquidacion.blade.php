                ...
                <div class="col-lg-12 col-md-12">
                    <div class="row">
                        @foreach($resultados as $key => $resultado)
                            <div class="col-md-4 col-6"  style="position:relative;">
                                <img class="foto_liquidacion_{{ $key }}" src="/images/liquidacion.png" style="width:100px;position:absolute;top:0px;left:0;z-index:1;">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-12">
                                            <div class="shop-content">
                                                ...
                                                <ul class="shop-list">
                                                    ...
                                                    <li><b style="color:red;">SOLO EN TIENDA ONLINE</b></li>
                                                    </li>

                                                     <li class="info_proveedor_{{ $key }}" style="display:none;">
                                                          {{ $resultado->disponibilidad }}<br>
                                                          {{ $resultado->especial }}
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="pagination-area">
                            @if($pagina > 1)
                                <a href="{{\Request::url()."?p=".($pagina-1)}}" class="prev page-numbers">
                            ...
                            @foreach($botones as $key => $value)
                                ...
                                @else
                                    <a href="{{\Request::url()."?p=".$value}}" class="page-numbers">{{$value}}</a>
                                @endif
                            @endforeach
                            @if($pagina < ceil($total_resultados/51))
                                <a href="{{\Request::url()."?p=".($pagina+1)}}" class="next page-numbers">
