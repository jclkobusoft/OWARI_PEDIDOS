                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-1">
                                <div class="form-check">
                                  <input class="form-check-input tipo_cliente" type="radio" name="tipo_pedido" id="pedido_normal" style="width: 20px; height: 20px;" value="normal">
                                  <label class="form-check-label" for="pedido_normal" style="font-size: 15px;margin:3px 0 0 5px;">
                                    Pedido normal
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input tipo_cliente" type="radio" name="tipo_pedido" id="pedido_todo_factura" style="width: 20px; height: 20px;" value="factura">
                                  <label class="form-check-label" for="pedido_todo_factura" style="font-size: 15px;margin:3px 0 0 5px;" >
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Clave articulo"
                                                        aria-label="Palabras o clave articulo" aria-describedby="boton-buscar"
                                                        id="palabras_clave" />
                                                    <button class="btn btn-outline-secondary" type="button" id="boton-buscar">
                                                        Buscar
                                                    </button>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-12 mt-3 mb-3">
                                                        <div class="input-group">
                                                            <input type="file" class="form-control" id="excel"
                                                                    ...
                                                                    aria-label="Upload" />
                                                                    <button class="btn btn-outline-secondary" type="button" id="subir_excel">Agregar partidas</button>
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group mb-3 col-md-6">
                                                                <input type="text" class="form-control" placeholder="Su pedido"
                                                                    name="su_pedido" maxlength="20" id="su_pedido"/>
                                                            </div>
                                                        <div class="d-flex justify-content-end">
                                                        <button type="button" class="btn btn-primary float-right" id="guardar">Generar pedido</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer-especiales" style="display: none;">
            <button type="button" class="btn btn-secondary terminar d-none" data-bs-dismiss="modal">Terminar</button>
        </div>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" onclick="descargarExcel()">Obtener excel de mi pedido</button>
            <button type="button" class="btn btn-secondary reiniciar_pantalla d-none" data-bs-dismiss="modal">Cerrar</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
    ...
    function actualizarPrecio(cantidad, codigo){
        ...
        $.each(partidas, function (i, obj) {
            if(obj.clave == codigo){
                ...
                } else precio = obj.descuentos[0].precio_lista;
    ...
    function buscarProducto($cliente, $clave, $cantidad,$equivalencias,$precio_normal) {
        $.get(
            "https://sistemasowari.com:8443/catalowari/api/empresa_buscar_producto",
    ...
    $("#subir_excel").click(function(e){
        if($("#excel")[0].files[0]){
            var leyenda= "<label>Espera un momento, se esta analisando tu archivo.</label>";
            ...
            function (data, textStatus, jqXHR) {
                 if(data.code){
                    ...
                    partidas_formulario = table_partidas.getData();
                     ...
                     var partes_empresa_uno = dividirEnPartes(data.partidas_a, 20);
                     var partes_empresa_tres = dividirEnPartes(data.partidas_b, 20);
...
<style>
    ...
    .mostrar_busqueda, .seleccionar_cliente {
        display: none;
    }
    ...
    #resultados_producto,.partidas,.mostrar_resultados {
        display: none;
    }
    .agregar-cantidad{display: none;}
