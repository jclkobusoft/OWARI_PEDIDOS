                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="product-content">
                                    ...
                                    <ul class="products-info info_proveedor" style="display: none;">
                                                    <li><b>{{ $producto->disponibilidad }}</b></li>
                                    ...
                                    <div class="product-quantities">
                                            ...
                                            <div class="input-counter input-counter-especial">
                                                ...
                                                <input name="cantidad" class="cantidad" type="text" value="1" min="1" max="1">
                                                <span class="plus-btn">
                                        ...
                                        setTimeout(() => {
                                                            $.get( "https://sistemasowari.com:8443/catalowari/api/empresa_buscar_producto",
                                                                    ...
                                                                    function (data, textStatus, jqXHR) {
                                                                            ...
                                                                            console.log(obj.en_liquidacion);
                                                                            ...
                                                                            if(obj.existencia > 0){
                                                                                $('.cantidad').attr('max',obj.existencia );
                                                                                $('.venta').show();
                                                                                $('.cantidad').blur(function(event) {
                                                                                    /* Act on the event */
                                                                                    if($(this).val() > obj.existencia){
                                                                                        alert('No puedes agregar mas cantidad de la que hay en disponibilidad');
                                                                                        $(this).val(1);
                                                                                    }
                                                                                });

                                                                                $('.input-counter-especial').each(function() {
    ...
    $('.cerrar_alerta').click(function (e) {
     ...
     $('.agregar_al_carrito').click(function (e) {
        ...
        if($cantidad > producto_partida.existencia){
            alert('No puedes agregar mas cantidad de la que hay en stock');
            $(this).val(1);
            return false;
        }
