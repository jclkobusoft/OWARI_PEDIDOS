...
<div class="container">
    <div class="card">
        <div class="card-header"><b>Generar plantilla de productos nuevos</b></div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form id="formulario">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex justify-content-end">
                         <button type="submit" class="btn btn-dark mt-2">Generar plantilla</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
            ...
            $(document).ready(function() {
                $('#formulario').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('compras.excel.productos.nuevos') }}",
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
