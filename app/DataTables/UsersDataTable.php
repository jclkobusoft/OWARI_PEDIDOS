...
class UsersDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('accion',function($q){
                return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic outlined example">
                  <a href="'.route('usuarios.editar',$q->id).'" type="button" class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar información del usuario"><i class="bi bi-pencil-square"></i></a>
    ...
    {
        return $model->where('cliente','f')->newQuery();
    }
